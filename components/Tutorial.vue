...
<template>
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0 Tutorial">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6 Tutorial__box">
...
export default {
  mounted(){
    this.$nextTick(()=>{
      ...
      tl.fromTo(this.$el.querySelector(".Tutorial__box"), {opacity:0}, {opacity: 1, duration: .5, ease: "none"})
    })
  }
}
</script>
